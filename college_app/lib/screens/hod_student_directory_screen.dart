...
//
// ═══════════════════════════════════════════════════════════════════
//  HOD STUDENT DIRECTORY  —  Extraordinary Edition
//  Fully themed for white/blue glassmorphism AppTheme
// ═══════════════════════════════════════════════════════════════════
//
//  FEATURES:
//  ─────────────────────────────────────────────────────────────────
//  • Animated stats banner  (Total / Defaulters / Avg Attendance)
//  • Stagger-animated card entries via StaggerEntry
//  • Animated attendance arc ring per student card (CustomPainter)
//  • Defaulter cards — pink glow border + warning pill
//  • Expandable detail panel per card:
//       – Contact info row
//       – Guardian details row
//       – Subject-wise animated progress bars with 75% threshold line
//  • Filter chips: All / Defaulters / Safe
//  • Sort cycling: Name A→Z / Z→A / Attend ↑ / Attend ↓
//  • Pull-to-refresh
//  • Shimmer skeleton loading state (ShimmerBox)
//  • Full error state + retry (GlowButton)
//  • Empty state per filter mode
//  • Page entry fade+slide animation
// ═══════════════════════════════════════════════════════════════════
